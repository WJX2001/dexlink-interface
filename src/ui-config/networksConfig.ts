...
export const networkConfigs: Record<string, BaseNetworkConfig> = {
  ...
  [ChainId.polygon]: {
    ...
    displayName: 'Polygon',
    privateJsonRPCUrl:
      'https://poly-mainnet.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
    publicJsonRPCUrl: [
  ...
  [ChainId.avalanche]: {
    name: 'Avalanche',
    privateJsonRPCUrl:
      'https://avax-mainnet.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
    publicJsonRPCUrl: [
  ...
  [ChainId.base]: {
    name: 'Base',
    privateJsonRPCUrl:
      'https://base-mainnet.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
    publicJsonRPCUrl: [
  ...
  [ChainId.harmony]: {
    name: 'Harmony',
    privateJsonRPCUrl:
      'https://harmony-0.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
    publicJsonRPCUrl: [
  ...
  [ChainId.optimism]: {
    name: 'Optimism',
    privateJsonRPCUrl:
      'https://optimism-mainnet.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
    publicJsonRPCUrl: [
  ...
  [ChainId.fantom]: {
    name: 'Fantom',
    privateJsonRPCUrl:
      'https://fantom-mainnet.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
    publicJsonRPCUrl: [
  ...
  [ChainId.metis_andromeda]: {
    ...
    privateJsonRPCUrl:
      'https://metis-mainnet.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
  ...
  [ChainId.xdai]: {
    name: 'Gnosis Chain',
    privateJsonRPCUrl:
      'https://gnosischain-mainnet.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
  ...
  [ChainId.bnb]: {
    ...
    privateJsonRPCUrl:
      'https://bsc-mainnet.rpc.grove.city/v1/62b3314e123e6f00397f19ca',
    publicJsonRPCUrl: [
  ...
  [ChainId.zksync]: {
    name: 'ZKsync',
    privateJsonRPCUrl:
      'https://zksync-mainnet.g.alchemy.com/v2/GyNpZOF5T0issE8wYgXXR_KJjUp-yds0',
   ...
   [ChainId.linea_testnet]: {
    ...
    wrappedBaseAssetSymbol: 'WETH',
    baseAssetDecimals: 18,
    explorerLink: 'https://sepolia.lineascan.build',
    // usdMarket: true,
    isTestnet: true,
    networkLogoPath: '/icons/networks/ethereum.svg',
  },
